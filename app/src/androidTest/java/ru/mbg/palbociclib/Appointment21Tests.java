...
public class Appointment21Tests {
    ...
    @Test
    public void appointmentOn21DayAssigned() {
    ...
    @Test
    public void pauseTreatmentOnGrade1() {
        try {
            Treatment treatment = sut.getPatient().getTreatments().last();
    ...
    @Test
    public void pauseTreatmentOnGrade2() {
        try {
            Treatment treatment = sut.getPatient().getTreatments().last();
    ...
    @Test
    public void pauseTreatmentOnGrade3NoFever() {
        try {
            Treatment treatment = sut.getPatient().getTreatments().last();
    ...
    @Test
    public void stopTreatmentOnGrade4SmallDose() {
        try {
            final Treatment treatment = sut.getPatient().getTreatments().last();
            testRealm.executeTransaction(new Realm.Transaction() {
                @Override
